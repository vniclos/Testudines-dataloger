...
__uint32_t g_sta_I  nterval_dd = 5;//30;       //    1/2h

#else
__uint32_t g_sta_Interval_yy =  1440; // = 24 * 60 = 24h
__uint32_t g_sta_Interval_mm =  360; //  =  6 * 60 =  6h
__uint32_t g_sta_Interval_dd =   15; //  =  15 minutes
#endif
...
Cls_CapacitiveMoisture g_device_CapMoisture = Cls_CapacitiveMoisture();
