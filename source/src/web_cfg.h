...
<br><span id="scnBodyTopDlBtn"></span>
</fieldset>
...
<br/><span id="scnBodyTopTimeBtn"></span>
</fieldset> <fieldset>
<legend>Wifi:</legenD>
Wifi mode <br/>
...
<br/>IP<br/><input id="scnIp" placeholder="192.168.1.10" type="text" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$">
<span id="scnIpMsg" style="color:#fff;">.</span>
<br/>Mask<br/><input id="scnIpMask" placeholder="255.255.255.0" type="text" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$">
<span id="scnIpMaskMsg" style="color:#fff;">.</span>
<br/>Gateway<br/><input id="scnIpGate" placeholder="192.168.1.1" type="text" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$">
<span id="scnIpGateMsg" style="color:#fff;">.</span>


<br/>DNS 1<br/><input id="scnIpDns1" placeholder="8.8.8.8" type="text" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$">
<span id="scnIpDns1Msg" style="color:#fff;">.</span>
<br/>DNS 2<br/><input id="scnIpDns2" placeholder="8.8.4.4" type="text" minlength="7" maxlength="15" size="15" pattern="^((\d{1,2}|1\d\d|2[0-4]\d|25[0-5])\.){3}(\d{1,2}|1\d\d|2[0-4]\d|25[0-5])$">
<span id="scnIpDns2Msg" style="color:#fff;">.</span>


</fieldset>
<br/><button onclick="fncCfgSetWifi();return false;">Set wifi config</button>
<br/><span id="scnBodyTopWifiBtn"></span> 


</fieldset> <div id="scnBodyBottom">debug</div>
