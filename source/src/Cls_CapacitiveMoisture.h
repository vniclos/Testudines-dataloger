...
#ifndef CLS_CAPACITIVE_MOISURE_H
#define CLS_CAPACITIVE_MOISURE_H
#define CAPACITIVE_MOISURE_DEBUG_NO
#include <arduino.h>
...
class Cls_CapacitiveMoisture {

  public:
    Cls_CapacitiveMoisture();
    ~Cls_CapacitiveMoisture(void);
